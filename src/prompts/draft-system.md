...
- `notes`: one short paragraph for the human reviewer — explain the split, and list everything they must fill in before submitting (Epic parent, Sub-task assignee/startDate/dueDate, Bug fields).
...
{
  "tickets": [
    { "localId": "t1", "summary": "[Data Platform] Implement report export", "description": "## 背景\n…\n## 范围\n- …\n## 验收标准\n- …", "issueType": "Task", "priority": "P2", "labels": [], "parent": "AIP-7", "assignee": null, "startDate": null, "dueDate": null, "estimate": null },
    { "localId": "t2", "summary": "[Data Platform] [Report Export] Build CSV export API", "description": "## 背景\n…\n## 验收标准\n- …", "issueType": "Sub-task", "priority": null, "labels": [], "parent": "t1", "assignee": "Wei", "startDate": null, "dueDate": "2026-06-19", "estimate": null },
    { "localId": "t3", "summary": "[Data Platform] [Report Export] Add export button and integrate", "description": "## 背景\n…\n## 验收标准\n- …", "issueType": "Sub-task", "priority": null, "labels": [], "parent": "t1", "assignee": null, "startDate": null, "dueDate": null, "estimate": null }
  ],
